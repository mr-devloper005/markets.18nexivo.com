...
const inputClass = 'h-[3.1rem] border border-black/30 bg-white px-4 text-base font-medium text-black outline-none transition placeholder:text-black/35 focus:border-[#e87f24] focus:ring-2 focus:ring-[#ffc81e]/45'
const buttonClass = 'inline-flex h-[3.1rem] items-center justify-center border border-black bg-[#e87f24] px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:bg-black disabled:opacity-60'
